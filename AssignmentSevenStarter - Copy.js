...
//proposed points: 11 out of 15, the entire thing was working until I tried to use my own original texture and now is not generating any sort of image.
// All of the code is the samea and the console error was telling me that I had a problem with the starter code that was given to me that I did not alter. 
// I tried to put the original museum text back into the image and now it isn't working. I haven't changed any of the code, but I think it should all be in there
//and work but I'm probably doing something wrong.
...
function loadPoints(points,texture) {
    ...
    //Mona Lisa
    points.push(vec4(-3.0, 8 , 0, 1));
    texture.push(vec2(0.5, 1));
    points.push(vec4(-3.0 , 2 , 0, 1));
